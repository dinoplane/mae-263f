...
\begin{figure}
        \begin{minipage}[b]{.45\linewidth}
                ...
                \end{tabular}
                \captionof{table}{A table of plate properties per side length \#} \label{fig:plateproperties} 
        \end{minipage}
        \begin{minipage}[b]{.45\linewidth}
                \centering
                \includegraphics[width=1.0\linewidth]{tablecloth.png}
                \captionof{figure}{The tablecloth configuration of the cloth} \label{fig:tablecloth}
        \end{minipage}
        \begin{minipage}[b]{.45\linewidth}
                \begin{center}
        ...
        \begin{minipage}[b]{.45\linewidth}
                ...
                \captionof{figure}{Graph of average frame times per simulation} \label{fig:frametimesgraph}
        \end{minipage}
\end{figure}
...
\begin{figure}
        ...
        \begin{minipage}[b]{.45\linewidth}
                ...
                \captionof{figure}{Graph of ratio of force to solver time} \label{fig:ratiosgraph}
        \end{minipage}
\end{figure}
...
\begin{figure}
        ...
        \begin{minipage}[b]{.45\linewidth}
                ...
                \captionof{figure}{Graph of simulation speedups} \label{fig:speedupsgraph}
        \end{minipage}
\end{figure}
